...
import AllRemote from "../../JSON/allClusters/allRemote.json";
...
const MapWrapper = () => {
  ...
  React.useEffect(() => {
    ...
    //              Remote      Remote
    const markers = AllRemote.map((AllRemote, i) => {
                ...
                <Row>
                  ...
                  <Col xs={6} md={2}>
                    ...
                    <MyModal
                      ...
                      titleone="Business Development"
                      // imgone={NatDeploy}
                      altone="Business Development"
