...
import OnsiteCluster from "../../JSON/community/OnsiteCluster.json";
...
const MapWrapper = () => {
  ...
  React.useEffect(() => {
    ...
    //              Remote      Remote
    const markers = OnsiteCluster.map((OnsiteCluster, i) => {
      return new google.maps.Marker({
        //        Remote
        position: OnsiteCluster,
        map: map,
        //      Remote
        title: "Rating: ★ ★ ★ ★ ☆ ",
        icon: OnsiteCluster.icon,
        label: OnsiteCluster.label,
        animation: google.maps.Animation.DROP,
      });
    });
