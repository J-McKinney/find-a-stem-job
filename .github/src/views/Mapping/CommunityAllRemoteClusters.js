...
import RemoteCluster from "../../JSON/community/RemoteCluster.json";
...
const MapWrapper = () => {
  ...
  React.useEffect(() => {
    ...
    //              Remote      Remote
    const markers = RemoteCluster.map((RemoteCluster, i) => {
      return new google.maps.Marker({
        //        Remote
        position: RemoteCluster,
        map: map,
        //      Remote
        title: "Rating: ★ ★ ★ ★ ☆ ",
        icon: RemoteCluster.icon,
        label: RemoteCluster.label,
        animation: google.maps.Animation.DROP,
      });
    });
          ...
          <Col xs={12} md={4}>
            <Card className="card-chart">
              <CardBody style={{ textAlign: "center" }}>
                <div>
                  Remote GIGs:{" "}
                  <Link to="/admin/CommunityAllRemoteClusters">
                    <Button
                      style={{
                        background: "red",
                        borderRadius: "12px",
          ...
          <Col xs={12} md={4}>
            <Card className="card-chart">
              <CardBody style={{ textAlign: "center" }}>
                <div>
                  Hybrid GIGs:{" "}
                  <Link to="/admin/CommunityAllHybridClusters">
                    <Button
                      style={{
                        background: "green",
                        borderRadius: "12px",
          ...
          <Col xs={12} md={4}>
            <Card className="card-chart">
              <CardBody style={{ textAlign: "center" }}>
                <div>
                  Onsite GIGs:{" "}
                  <Link to="/admin/CommunityAllOnsiteClusters">
                    <Button
                      style={{
                        background: "orange",
                        borderRadius: "12px",
