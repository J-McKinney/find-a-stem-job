...
import KCluster from "../../JSON/stem/KCluster.json";
...
const MapWrapper = () => {
  ...
  React.useEffect(() => {
    ...
    //              Remote      Remote
    const markers = KCluster.map((KCluster, i) => {
          ...
          <Col xs={12} md={4}>
            <Card className="card-chart">
              <CardBody style={{ textAlign: "center" }}>
                <div>
                  Remote GIGs:{" "}
                  <Link to="/admin/StemAllRemoteClusters">
                    <Button
                      style={{
                        background: "red",
                        borderRadius: "12px",
          ...
          <Col xs={12} md={4}>
            <Card className="card-chart">
              <CardBody style={{ textAlign: "center" }}>
                <div>
                  Hybrid GIGs:{" "}
                  <Link to="/admin/StemAllHybridClusters">
                    <Button
                      style={{
                        background: "green",
                        borderRadius: "12px",
          ...
          <Col xs={12} md={4}>
            <Card className="card-chart">
              <CardBody style={{ textAlign: "center" }}>
                <div>
                  Onsite GIGs:{" "}
                  <Link to="/admin/StemAllOnsiteClusters">
                    <Button
                      style={{
                        background: "orange",
                        borderRadius: "12px",
        ...
        <Row>
          <Col xs={12}>
            ...
            <Row>
              {/* 
              STEM Graph  
              Total Students in program 25 
              Total STEM GIGs Completed 35
              Total Student Placements 25
               */}
              <Col xs={12} md={4}>
                <Card
                  style={{
