...
import HybridCluster from "../../JSON/community/HybridCluster.json";
...
const MapWrapper = () => {
  ...
  React.useEffect(() => {
    ...
    //              Remote      Remote
    const markers = HybridCluster.map((HybridCluster, i) => {
      return new google.maps.Marker({
        //        Remote
        position: HybridCluster,
        map: map,
        //      Remote
        title: "Rating: ★ ★ ★ ★ ☆ ",
        icon: HybridCluster.icon,
        label: HybridCluster.label,
        animation: google.maps.Animation.DROP,
      });
    });
